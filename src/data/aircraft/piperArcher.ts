  ...
  referenceData: [
    ...
    },
    {
      ...
      items: {
        ...
        'Standard Empty Weight': '~1,418 lbs (varies)',
        'Max Useful Load': '~1,132 lbs (varies)',
        'Fuel Capacity': '50 gal',
        'Usable Fuel': '48 gal',
        'Cruise Fuel Burn': '~10 GPH (75% power)',
        'Oil Capacity': '8 qts max / 2 qts min',
        'Cruise Range (est.)': '~520 NM',
        'Service Ceiling': '14,100 ft',
        'Takeoff Ground Roll': '1,600 ft (SL, 59°F, zero wind)',
        'Takeoff Over 50 ft Obstacle': '2,540 ft (SL, 59°F, zero wind)',
        'Landing Ground Roll': '1,045 ft (SL, 59°F, zero wind)',
        'Landing Over 50 ft Obstacle': '1,625 ft (SL, 59°F, zero wind)',
  ...
  phases: [
    {
      ...
      items: [
        ...
        { id: 'pf-43', action: 'Oil level', response: 'CHECK — 6 qt minimum for flight, 8 qt full; cap secure', severity: 'warning' },
