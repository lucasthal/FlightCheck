  ...
  referenceData: [
    ...
    },
    {
      ...
      items: {
        ...
        'Standard Empty Weight': '~1,316 lbs (varies)',
        'Max Useful Load': '~1,124 lbs (varies)',
        'Fuel Capacity': '50 gal',
        'Usable Fuel': '48 gal',
        'Cruise Fuel Burn': '~9 GPH (75% power)',
        'Oil Capacity': '8 qts max / 2 qts min',
        'Cruise Range (est.)': '~440 NM',
        'Service Ceiling': '11,000 ft',
        'Takeoff Ground Roll': '1,065 ft (SL, 59°F, zero wind)',
        'Takeoff Over 50 ft Obstacle': '1,760 ft (SL, 59°F, zero wind)',
        'Landing Ground Roll': '595 ft (SL, 59°F, zero wind)',
        'Landing Over 50 ft Obstacle': '1,325 ft (SL, 59°F, zero wind)',
